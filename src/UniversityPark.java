...
public class UniversityPark extends JPanel {

    XML_240 x2;

    CharacterJPanel cjp;
    JLabel bannerLabel;
    JButton returnButton, goQuestion2, goQuestion3, goQuestion4, goQuestion5, tryAgain,
            hintButton, endButton, exit;
    ImageIcon returnImage = new ImageIcon("images/return.png");
    ImageIcon bannerImage = new ImageIcon("images/psu.university.bg.png");
    ...
    public UniversityPark(CharacterJPanel importedCharacterJPanel) {
        super();
...
//=====================================
        ...
        Dimension nq4Size = goQuestion5.getPreferredSize();
        goQuestion5.setBounds(300, 275, nq4Size.width, nq4Size.height);
        add(goQuestion5);
...
//=====================================  
    ...
    public void showMessage() {
        JOptionPane.showMessageDialog(null, "<html>Math quiz time!<br>"
                + "Choose the correct answer,<br>good luck!<html>");
    }
