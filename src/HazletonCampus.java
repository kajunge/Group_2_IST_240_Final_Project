...
public class HazletonCampus extends JPanel implements ActionListener {
    ...
    ImageIcon bannerImage = new ImageIcon("images/psu.hazleton.bg.png");
    ...
    ImageIcon panther = new ImageIcon("images/panther.png");
    ImageIcon NBC = new ImageIcon("images/nbc.jpg");
    ImageIcon lambda = new ImageIcon("images/lambda.png");
    ...
    double i, point, score;

    public HazletonCampus(CharacterJPanel importedCharacterJPanel) {
        super();
...
//=====================================          
        ...
        image1 = new JLabel(banana);
        Dimension bSize1 = image1.getPreferredSize();
        image1.setBounds(0, 330, bSize1.width, bSize1.height);
        add(image1);
        image1.setOpaque(false);
        image1.setVisible(true);

        image2 = new JLabel(panther);
        Dimension bSize2 = image2.getPreferredSize();
        image2.setBounds(180, 330, 120, 120);
        add(image2);
        image2.setOpaque(false);
        image2.setVisible(true);

        image3 = new JLabel(NBC);
        add(image3);
        Dimension bSize3 = image3.getPreferredSize();
        image3.setBounds(330, 290, 200, 200);
        image3.setOpaque(false);
        image3.setVisible(true);

        image4 = new JLabel(lambda);
        add(image4);
        image4.setBounds(530, 330, 120, 120);
        image4.setOpaque(false);
...
//=====================================  
        ...
        q3ChoicesList.addItem(question3Choice3);
        q3ChoicesList.addItem(question3Choice4);
...
//=====================================  
    ...
    public void showMessage() {
        JOptionPane.showMessageDialog(null, "<html>Name the Object that appears<br>in the image.<html>");
    }
...
// The game will display a picture and have four options for what appears in the image. There will b 3 questions with one image relating to each of the characters//
//When the Image is shown that relates to the character the player will only have 3 options to chose from because their character would be more knowledgeable about it//
